...
I build real-world projects using Splunk, Kali Linux, Windows Server, and networked environments (PK, EVE-NG, Firewalls) to demonstrate practical SOC skills.
...
- Networking: DHCP, VLANs, routing, firewall rules  
- Security Tools: Kali Linux, Wireshark, Nessus, OpenSSH  
- Automation: Bash, Python (beginner), Ansible (lab use)
...
- Threat detection  
- Incident response  
- Continuous learning through labs and certifications
